(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-item__slider")) new core(".main-slider__slider", {
            modules: [ Navigation, Lazy, Pagination, EffectFade ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            spaceBetween: 0,
            ...
            navigation: {
                prevEl: ".controll-main-slider__prev",
                nextEl: ".controll-main-slider__next"
            },
            on: {}
        });
        if (document.querySelector(".slider-item__slider")) new core(".slider-item__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
            ...
            loop: true,
            navigation: {
                nextEl: ".controll-item-slider__next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".slider-item__slider-right")) new core(".slider-item__slider-right", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
            ...
            loop: true,
            navigation: {
                nextEl: ".controll-item-slider__next-right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
